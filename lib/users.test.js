...
describe("users", () => {
    ...
    context("get", () => {
        ...
        it("should catch error if there is one", async (done) => {
            sandbox.restore();
            let stub = sandbox
                .stub(mongoose.Model, "findById")
    ...
    context("delete user", () => {
        ...
        it("should call users.remove", async () => {
            ...
            expect(deleteStub).to.calledWith({ _id: 123 });
        });
    });
    context("create user", () => {
        ...
        it("should reject invalid arguments", async () => {
            ...
            ).to.eventually.be.rejectedWith("Invalid argument");
            await expect(
        ...
        it("should call mailer with mail and name", () => {
    ...
    context("update user", () => {
        ...
        it("should reject if there is an error", async () => {
            ...
            await expect(users.update()).to.have.been.rejected;
            await expect(users.update()).to.have.been.rejectedWith("fake");
        });
    });
    ...
    context("reset password", () => {
        ...
        it("should check for email", async () => {
            await expect(users.resetPassword()).to.have.been.rejectedWith(
                "Invalid email"
            );
        });
