...
describe("order", () => {
    ...
    it("should create an instance of an Order and calculate total shipping", () => {
    ...
    it("should update the status to active and return the order details", () => {
        let result = o.save();
    ...
    it("should update shipped status", () => {
        o.ship();
        expect(dateSpy).to.have.been.calledThrice;
        expect(o)
            .to.have.property("status")
