...
describe("utils", () => {
    ...
    it("should return null if invalid string is passed", () => {
        ...
        expect(createHashStub).to.not.be.have.been.called;
    });
    ...
    it("should call crypt with correct settings and return hash", () => {
        expect(createHashStub).to.have.been.calledWith(
            "md5"
        );
