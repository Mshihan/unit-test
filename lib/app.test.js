    ...
    context("POST /user", () => {
        ...
        it("should  call user.create", (done) => {
            ...
            request(app)
                ...
                .expect(200)
                .end((err, res) => {
                    expect(createStub).to.have.been
                        .calledOnce;
                    expect(res.body)
                        .to.have.property("name")
                        .to.equal("foo");
        ...
        context("DELETE /user/:id", () => {
            ...
            it("should handle error for delete", (done) => {
                // var errorStub = sandbox
                //     .stub()
                //     .callsFake((res, err) => {
                //         return res
                //             .status(400)
                ...
                // app.__get__("handleError", errorStub);
        ...
        context("handleError", () => {
            let handleError, res, jsonStub, statusStub;
            ...
            it("should check error instance and format message", (done) => {
                ...
                expect(statusStub).to.have.been.calledWith(
                    400
                );
